...
app.use(express.static(__dirname + '/' + "menu"));

 
//app.use(express.static(path.join(__dirname, 'menu')));
app.get('/', function (req, res) {
  res.send('<html><body><h1>Hello Anya</h1></body></html>');
});
...
http.createServer(app).listen(app.get('port'), function(){
  console.log('Express 2server listening on port ' + app.get('port') + __dirname + '/' + "public");
});
